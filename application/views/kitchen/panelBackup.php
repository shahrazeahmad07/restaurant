                ...
                $show_all_orders .= '<div class="fix floatleft single_order" data-order-type="'.$order_type.'" data-selected="'.$selected_unselected.'" id="single_order_'.$singleOrder->sale_id.'">';
                    $show_all_orders .= '<div class="header_portion light-blue-background fix">';
                        $show_all_orders .= '<div class="fix floatleft" style="width:70%;">';
                            $show_all_orders .= '<p class="order_number">Invoice: '.$order_name.'</p> ';
                            $show_all_orders .= '<p class="order_number">Customer Name: '.$singleOrder->customer_name.'</p> ';
                            $show_all_orders .= '<p class="order_number">Waiter Name: '.$singleOrder->waiter_name.'</p> ';
                            $show_all_orders .= '<p class="order_number">Table: '.$tables_booked.'</p> ';
                            $show_all_orders .= '<p class="order_number">Order Type: '.$order_type.'</p> ';
                        $show_all_orders .= '</div>';
...
<html class="gr__localhost">
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/kitchen_panel/js/jquery.slimscroll.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/kitchen_panel/js/sweetalert2.all.min.js"></script>
    ...
    <body>
        ...
        <div class="wrapper fix">
            <div class="fix main_top">
                <div class="fix floatleft top_header"><h1>Kitchen Panel</h1></div>
    ...
    <div id="help_modal" class="modal">
        ...
        <div class="modal-content" id="modal_help_content">
            ...
            <p class="help_content">
                You should click on one/multiple item to mark it as Started Cooking or Done. </br>
                You can not select any item for Take Away or Delivery type orders, as you need to deliver these type of orders as a pack Blue color indicates Started Cooking, where green color indicates that the item is Done cooking. <br/> 
