                ...
                <div id="receipt-data">
                    ...
                    <p>Date: <?= date($this->session->userdata('date_format'), strtotime($sale_object->sale_date)); ?> <?= date('H:i',strtotime($sale_object->order_time)) ?><br>
                       <!--  Sales Associate: <?php echo $sale_object->user_name; ?><br> -->
                        Customer: <?php echo "$sale_object->customer_name"; ?><br>
                          <?php 
                       if($sale_object->order_type==2 ||$sale_object->order_type==3 ){
                       }else{
                        echo 'Table:   '.$table_name = $this->db->get_where('tbl_tables', array('id' => $sale_object->table_id))->row()->name; 
                       }
                         ?>
...
<td><?php echo "Rs: " . $row->menu_price_without_discount; ?></td>
 </tr>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th>Sub Total</th>
                                <th class="text-right" colspan="2" ><?php echo $this->session->userdata('currency') . " " . number_format($sale_object->sub_total); ?></th>
                            </tr>
                        <th>Disc Amt (%):</th>
                        <th class="text-right" colspan="2"><?php echo $this->session->userdata('currency') . " " . $sale_object->total_discount_amount; ?></th>
                        </tr>
                        <th colspan="2">Service  Charge:</th>
                        <th class="text-right" colspan="2" ><?php echo $this->session->userdata('currency') . " " . $sale_object->delivery_charge; ?></th>
                        </tr>
                        <?php
                        ...
                        <tr>
                            <th >Grand Total</th>
                            <th class="text-right" colspan="2"><?php echo $this->session->userdata('currency') . " " . number_format($sale_object->total_payable, 2); ?></th>
                        </tr>
                        <tr>
                            <th>Paid Amount</th>
                            <th class="text-right" colspan="2"><?php echo $this->session->userdata('currency') . " " . number_format($sale_object->paid_amount, 2); ?></th>
                        </tr>
                        <tr>
                            <th>Due Amount</th>
                            <th class="text-right" colspan="2"><?php echo $this->session->userdata('currency') . " " . number_format($sale_object->due_amount, 2); ?></th>
                        </tr>
                        </tfoot>
                    </table>
