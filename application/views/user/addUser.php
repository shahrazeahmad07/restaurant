                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="full_name" class="form-control" placeholder="<?php echo lang('name'); ?>" value="<?php echo set_value('full_name'); ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="3" type="text" name="email_address" class="form-control" placeholder="<?php echo lang('email_address'); ?>" value="<?php echo set_value('email_address'); ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="2" type="text" name="designation" class="form-control" placeholder="<?php echo lang('designation'); ?>" value="<?php echo set_value('designation'); ?>">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group radio_button_problem">
                                ...
                                <div class="radio">
                                    <label> 
                                        <input tabindex="5" type="radio" name="will_login" id="will_login_yes" value="Yes">Yes </label>
                                    <label>

                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 

                                        <input tabindex="6" type="radio" name="will_login" id="will_login_no" value="No" checked>No 
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input tabindex="5" type="text" name="password" class="form-control" placeholder="<?php echo lang('password'); ?>" value="<?php echo set_value('password'); ?>">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input tabindex="4" type="text" name="confirm_password" class="form-control" placeholder="<?php echo lang('confirm_password'); ?>" value="<?php echo set_value('confirm_password'); ?>">
                                </div>
