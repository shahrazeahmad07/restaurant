                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <div class="navbar-custom-menu">
                       <ul class="nav navbar-nav">
                            ...
                            style="width: 150px;padding-top: 12px;">
...
<?php if (in_array('Report', $this->session->userdata('menu_access'))) { ?> 
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url(); ?>Report/registerReport"><i class="fa fa-angle-double-right"></i>Register Report</a></li>  
                                        <li><a href="<?php echo base_url(); ?>Report/dailySummaryReport"><i class="fa fa-angle-double-right"></i>Daily Summary Report</a></li>  
                                        <li><a href="<?php echo base_url(); ?>Report/foodMenuSales"><i class="fa fa-angle-double-right"></i>Food Sale Report</a></li>
                                        <li><a href="<?php echo base_url(); ?>Report/saleReportByDate"><i class="fa fa-angle-double-right"></i>Daily Sale Report</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Report/detailedSaleReport"><i class="fa fa-angle-double-right"></i>Detailed Sale Report</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Report/consumptionReport"><i class="fa fa-angle-double-right"></i>Consumption Report</a></li>
                                        <li><a href="<?php echo base_url(); ?>Report/inventoryReport"><i class="fa fa-angle-double-right"></i>Inventory Report</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Inventory/getInventoryAlertList"><i class="fa fa-angle-double-right"></i>Low Inventory Report</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Report/profitLossReport"><i class="fa fa-angle-double-right"></i>Profit Loss Report</a></li>
                                        <li><a href="<?php echo base_url(); ?>Report/vatReport"><i class="fa fa-angle-double-right"></i>VAT Report</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Report/kitchenPerformanceReport"><i class="fa fa-angle-double-right"></i>Kitchen Performance Report</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Report/attendanceReport"><i class="fa fa-angle-double-right"></i>Attendance Report</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Report/supplierReport"><i class="fa fa-angle-double-right"></i>Supplier Ledger</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Report/supplierDueReport"><i class="fa fa-angle-double-right"></i>Supplier Due Report</a></li>
                                        <li><a href="<?php echo base_url(); ?>Report/customerDueReport"><i class="fa fa-angle-double-right"></i>Customer Due Report</a></li>
                                        <li><a href="<?php echo base_url(); ?>Report/customerReport"><i class="fa fa-angle-double-right"></i>Customer Ledger</a></li> 
                                        <!-- <li><a href="<?php echo base_url(); ?>Report/saleReportByMonth"><i class="fa fa-angle-double-right"></i>Sale Report by Month</a></li>  --> 
                                        <li><a href="<?php echo base_url(); ?>Report/purchaseReportByDate"><i class="fa fa-angle-double-right"></i>Purchase Report</a></li> 
                                        ...
                                        <li><a href="<?php echo base_url(); ?>Report/expenseReport"><i class="fa fa-angle-double-right"></i>Expense Report</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Report/wasteReport"><i class="fa fa-angle-double-right"></i>Waste Report</a></li> 
                                    </ul>
                                </li>
                            <?php } ?>  
<?php if (in_array('Master', $this->session->userdata('menu_access'))) { ?> 
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url(); ?>Master/ingredientCategories"><i class="fa fa-angle-double-right"></i>Ingredient Categories</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/Units"><i class="fa fa-angle-double-right"></i>Ingredient Units</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/ingredients"><i class="fa fa-angle-double-right"></i>Ingredients</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/VATs"><i class="fa fa-angle-double-right"></i>VATs</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/modifiers"><i class="fa fa-angle-double-right"></i>Modifiers</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/foodMenuCategories"><i class="fa fa-angle-double-right"></i>Food Menu Categories</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/foodMenus"><i class="fa fa-angle-double-right"></i>Food Menus</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/suppliers"><i class="fa fa-angle-double-right"></i>Suppliers</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/customers"><i class="fa fa-angle-double-right"></i>Customers</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Master/expenseItems"><i class="fa fa-angle-double-right"></i>Expense Items</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/employees"><i class="fa fa-angle-double-right"></i>Employees</a></li>
                                        <li><a href="<?php echo base_url(); ?>Master/paymentMethods"><i class="fa fa-angle-double-right"></i>Payment Methods</a></li> 
                                        <li><a href="<?php echo base_url(); ?>Master/tables"><i class="fa fa-angle-double-right"></i>Tables</a></li> 
                                    </ul>
                                </li>
<?php } ?> 
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="<?php echo base_url(); ?>Authentication/setting/<?php echo $this->session->userdata('company_id') ?>"><i class="fa fa-angle-double-right"></i>General Settings</a></li>
                                    <li><a href="<?php echo base_url(); ?>Authentication/setting/<?php echo $this->session->userdata('company_id') ?>"><i class="fa fa-angle-double-right"></i>Backup/Restore</a></li>
                                    <li><a href="<?php echo base_url(); ?>Authentication/SMSSetting/<?php echo $this->session->userdata('company_id') ?>"><i class="fa fa-angle-double-right"></i>SMS Setting</a></li>
                                    <?php if (in_array('User', $this->session->userdata('menu_access'))) { ?>  
                                        <li><a href="<?php echo base_url(); ?>User/users"><i class="fa fa-angle-double-right"></i>Manage Users</a></li> 
<?php } ?>
                                    <li><a href="<?php echo base_url(); ?>Authentication/changeProfile"><i class="fa fa-angle-double-right"></i>Change profile</a></li>
                                    <li><a href="<?php echo base_url(); ?>Authentication/changePassword"><i class="fa fa-angle-double-right"></i>Change Password</a></li>
                                    <li><a href="<?php echo base_url(); ?>Authentication/logOut"><i class="fa fa-angle-double-right"></i>Logout</a></li>
                                </ul>
                            </li> 
            ...
            <footer class="main-footer">  
                <div class="row">
                    <div class="col-md-12" style="text-align: center;">
                        <strong>HANGRY</strong>, Developed By The Profexo IT Solutions
                        <div class="hidden-lg">
